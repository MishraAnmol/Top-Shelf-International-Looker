view: contribution_margins {
  ...
  measure: c3_margin  {
    type: number
    sql: ${sales_by_order.c3_margin};;
      }

  measure: c4_margin  {
    type:  number
    sql: ${c3_margin} - ${stock_overheads_val};;
  ...
  measure: c5_margin_perc  {
    sql: ${c5_margin}*100/${abs_net_sales_amount} ;;
    value_format: "0.00\%"
    drill_fields: [detail*]
    description: "Contribution Margin 4 : Net sales less Product, Excise, Freight, CDS, Sample stock, Ad & Promo costs"
  }
